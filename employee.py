...
class employeeClass:
    def __init__(self, root):
        ...
        #*****Content*****
        lbl_empid=Label(self.root,text="Emp ID",font=("Goudy old style",15),bg ="White").place(x=240,y=150)
        lbl_gender=Label(self.root,text="Gender",font=("Goudy old style",15),bg ="White").place(x=550,y=150)
        ...
        lbl_contact=Label(self.root,text="Contact",font=("Goudy old style",15),bg ="White").place(x=950,y=150)

        txt_empid=Entry(self.root,textvariable=self.var_emp_id,font=("Goudy old style",15),bg ="White").place(x=50,y=150,width=180)
        txt_gender=Entry(self.root,textvariable=self.var_gender,font=("Goudy old style",15),bg ="White").place(x=350,y=150,width=180)
        txt_contact=Entry(self.root,textvariable=self.var_contact,font=("Goudy old style",15),bg ="White").place(x=750,y=150,width=180)
