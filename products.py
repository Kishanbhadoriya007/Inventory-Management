...
class ProductsClass:
    def __init__(self, root):
        ...
        #===searchframe===
        SearchFrame=LabelFrame(self.root,text="Search Products",bg="White")
        ...
        #====text====
        title=Label(self.root,text="Products Details",font=("Goudy old style",15),bg ="blue",fg="white").place(x=50,y=100,width=1000)
