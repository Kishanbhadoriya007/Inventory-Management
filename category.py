...
class CategoryClass:
    def __init__(self, root):
        ...
        #===searchframe===
        SearchFrame=LabelFrame(self.root,text="Search Categories",bg="White")
        ...
        #====text====
        title=Label(self.root,text="Categories",font=("Goudy old style",15),bg ="blue",fg="white").place(x=50,y=100,width=1000)
