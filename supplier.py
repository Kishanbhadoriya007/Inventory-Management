...
class SupplierClass:
    def __init__(self, root):
        ...
        self.root.focus_force()
         #===searchframe===
        SearchFrame=LabelFrame(self.root,text="Search Suppliers",bg="White")
        ...
        #====text====
        title=Label(self.root,text="Suppliers Details",font=("Goudy old style",15),bg ="blue",fg="white").place(x=50,y=100,width=1000)
